...
#        elif current[-1][1] < limit_voltage/100:
#            # Discard last measured values
#            del temp[-1]
#            del current[-1]
#            del voltage[-1]
...
#        
#            # Decrease limits
#            limit_voltage = limit_voltage/10
#            sm.set_limit_voltage(sm2901, limit_voltage)
#            limit_hit = 1
#            instr.log_and_print(log, 'Current limit decreased to %0.0e A at %2.1d s after start' % (limit_voltage, t))
