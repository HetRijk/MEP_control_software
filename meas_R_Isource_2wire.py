...
source_current  = 1E-10
limit_voltage   = 1E1

sleep_time      = 60*5

meas_name = 'Pt_WO3193_2point' 
...
# Connect to device
sm2901 = sm2901 = instr.connect('USB0::0x0957::0x8B18::MY51141059::INSTR')
...
instr.log_and_print(log, 'Now waits for %s s' % sleep_time)

instr.sleep(sleep_time)
