...
Resistance measurement under current sourcing
"""
...
plt.title('Voltage measured with source current %s A' % source_current)
plt.xlabel('t(s)')
...
plt.title('Current with source current %s A' % source_current)
plt.xlabel('t(s)')
...
plt.title('Resistance with source current %s A' % source_current)
plt.xlabel('t(s)')
