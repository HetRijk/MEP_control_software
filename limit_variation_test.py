# -*- coding: utf-8 -*-
"""
Created on Tue Oct 29 16:24:19 2019

@author: LocalAdmin

Stability measurement as a function of compliance limit
"""
...
def measurement(tc332, sm2901, dmm2100, meas_time, sample_rate, main_time):
    ...
    while t_meas2 < meas_time:
        ...
        limits.append([t, sm.get_limit_current(sm2901)])
        
        if t_meas2 > 199 and t_meas2 < 200:
            sm.set_limit_current(sm2901, sm.get_limit_current(sm2901)*10)
        if t_meas2 > 399 and t_meas2 < 400:
            sm.set_limit_current(sm2901, sm.get_limit_current(sm2901)*10)        
...
meas_name = 'wo3189_r13_limit_variation_test' 
